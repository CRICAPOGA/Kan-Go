"""
Django settings for KanAndGo project.
...
SECRET_KEY = 'django-insecure-gi6%%5*t_^^)yx%atb@-d^(=)(h1qks^6rg8v#_eoikxb#zh+l'
...
ROOT_URLCONF = 'KanAndGo.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            BASE_DIR / 'KanAndGo' / 'templates',
...
WSGI_APPLICATION = 'KanAndGo.wsgi.application'
...
LOGIN_URL = '/autenticacion/acceso/'
